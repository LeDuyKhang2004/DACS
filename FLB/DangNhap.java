...
public class DangNhap {
	...
	public static void main(String[] args) {
		...
		//Title FlappyBird
		BufferedImage resized = Helper.resizeImage(new ImageIcon(DangNhap.class.getResource("/res/flappy-bird-logo.png")).getImage(), 262, 70);
	...
	public void draw(Graphics g) {
		...
		BufferedImage resized = Helper.resizeImage(titleImg, 262, 60);
